// w2-seed.ts — จำลองข้อมูล W2 field sprint (40 venues + routes จริง)
// รัน: tsx tests/w2-seed.ts > lib/fixtures.ts
...
// 40 venues (10 work + 6 date + 4 family + 4 photo) + 16 routes (8 origins)
...
export const BUDGET_DEFAULTS: Record<Intent, number> = ${JSON.stringify(BUDGET_DEFAULTS, null, 2)};
